...
public class MenuAdministrador {
        ...
        switch (opcion) {
            case 1:
                ...
                Paciente paciente = new Paciente(id, nombrePaciente, apellidoPaciente, fechaNacimientoPaciente,
                        numeroTelefonoPaciente, contraseñaPaciente, correoPaciente, Rol.PACIENTE, tipoDeSangre, sexo);
            ...
            case 2:
                ...
                Medico medicoT = new Medico(id, nombreMedico, apellidoMedico, fechaNacimientoMedico, numeroTelefonoMedico,
                        contraseñaMedico, correoMedico,  Rol.MEDICO, rfc);


                Medico medico = new Medico(hospital.generarIdMedico(medicoT), nombreMedico, apellidoMedico,
                        fechaNacimientoMedico, numeroTelefonoMedico, contraseñaMedico, correoMedico, Rol.MEDICO, rfc);
    ...
    private ArrayList<String> obtenerDatosComun(Rol rol, Hospital hospital) {
        ...
        datosEnComun.add(obtenerFechaDeNacimientoUsuario(tipoUsuario));
    ...
    /// GENERICO tiene como tipo lo que sea (T o V) que recibe cualquier tipo de dato (Arraylist puede ser de cualquier tipo que yo le pase)
    /// Listas de Administradores, medicos o pacientes pq extiende de usuario

    private boolean validarTelefonoRepetido (ArrayList <? extends Usuario > listaUsuarios, String telefono) {
        for (Usuario usuario : listaUsuarios) {
            if (usuario.getTelefono().equals(telefono)) {
                System.out.println("Ya existe un usuario registrado con ese teefono. Intenta de nuevo");
            }
        }
            return false;
    }

    private String obtenerFechaDeNacimientoUsuario(String tipoUsuario) {
        ...
        while (!esFechaValida) {
            ...
            if (fechaDeNacimiento.isAfter(fechaDeNacimiento)) {
                System.out.println("La fecha no puede ser posterior al día de hoy. Intentelo de nuevo");
            } else esFechaValida = true;
