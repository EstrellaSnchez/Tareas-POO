                ...
                while (opcion != 12) {
                    ...
                    switch (opcion) {
                        ...
                        case 4:
                            ...
                            int numeroConsultorioC = scanner.nextInt();
        
                            LocalDateTime fechaConsulta = LocalDateTime.of(añoConsulta, mesConsulta, diaConsulta, horaConsulta, minutoConsulta);
        
                           if(validadorHospital.validarDisponibilidadFechaConsulta(fechaConsulta, numeroConsultorioC,hospital.getListaConsultas() ))
